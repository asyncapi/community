...
// in the /tweets/ directory, under a dedicated directory that indicates it is reoccuring tweet
...
const customDestinyDir = path.join(__dirname,`../../tweets/reoccuring-${filenameNoExt}`); //gives us for example "tweets/reoccuring-discuss-ideas"
...
const copyDest = `${customDestinyDir}/${date}.tweet`; //gives us for example "tweets/reoccuring-discuss-ideas/2021-10-14.tweet"
