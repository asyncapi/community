...
* Make sure the [charter](./docs/020-governance-and-policies/CHARTER.md) is respected.
...
* Must be a servant leader and has no power other than the specified in the [charter](./docs/020-governance-and-policies/CHARTER.md). Everything that is proposed should be voted by the TSC.
