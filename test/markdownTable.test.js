...
describe('jsonToMarkdownTable', () => {
  ...
  it('should visualize input JSON and verify Markdown table', async () => {
    ...
    expect(result).toContain('[Proposal](https://github.com/org/repo/issues/123)'); // Issue link in legend
    expect(result).toContain('## Vote index'); // Legend section heading
    expect(result).toContain('| #1 | [Proposal]'); // Short label + link in legend row
    expect(result).toContain('| GitHub handle | #1 |'); // Short label in main table header
