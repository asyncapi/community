...
Once you've made and committed your changes (following the Git Workflow guide), you need to create a Pull Request (PR) to propose merging your work into the official AsyncAPI repository. Make sure to use the [conventional commit style](../community/010-contribution-guidelines/conventional-commits) while creating PRs and follow these steps:  
