...
- **S5: The AsyncAPI Bounty Program** (Targets O1): Establish a budget schedule for the Bounty Program by setting aside TSC-approved budget voting at least forty-five days before the start of the budgetary period, ideally by November 15 for the annual budget, followed by a six-month review. The fixed schedule will provide AsyncAPI with greater predictability and flexibility in financial planning while ensuring timely adjustments to the budget as needed, and improving efficiency.
...
- **S7: Manage the Ambassador Program** (Targets O1): Continue monthly Ambassador meetings and identify additional Ambassadors to support the progr- **S8: Launch the Fellowship Program** (Targets O1): Lay the groundwork for the new program by creating documentation on its purpose and eligibility. Research and discuss criteria for selecting projects and create a communication plan. But to start work, it'll heavily rely on the execution of S1.
