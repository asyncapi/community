...
3. Supporting and committing to existing projects and being invited by other maintainers to join them as a maintainer. For more information, refer to [Become a maintainer in an existing project](../community/010-contribution-guidelines/Become-maintainer-in-existing-project).
